...
router.route('/')
    ...
    .post(verifyRoles(ROLES.Admin, ROLES.Editor),employeeController.createNewEmployee)
    .put(verifyRoles(ROLES.Admin, ROLES.Editor),employeeController.updateEmployee)
